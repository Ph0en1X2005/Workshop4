...
- Ход работы: для запуска программы откройте Anaconda-Navigator. Запустите инструмент Jupiter Notebook и в открывшемся окне браузера создайте папку с файлом .ipynb, вписав в него код.
```py
